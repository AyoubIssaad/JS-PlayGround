  ...
  window.jscolor = (function() {
    var jsc = {
      ...
      setStyle: (function() {
        ...
        const getSupportedProp = function(names) {
      ...
      jscolor(targetElement, options) {
        ...
        this.exportColor = function(flags) {
          ...
          if (!(flags & jsc.leaveStyle)) {
            if (this.styleElement) {
              const bgColor = `#${this.toString()}`;
              const fgColor = this.isLight() ? '#000' : '#FFF';
        ...
        this.toRGBString = function() {
          return `rgb(${Math.round(this.rgb[0])},${Math.round(
            this.rgb[1]
        ...
        function drawPicker() {
          ...
          p.padM.style.left = '0';
          p.padM.style.top = '0';
          p.padM.style.width = `${THIS.padding +
            2 * THIS.insetWidth +
            THIS.width +
            padToSliderPadding / 2}px`;
          ...
          p.crossBY.style.width = p.crossBX.style.height = `${2 *
            THIS.pointerBorderWidth +
            THIS.pointerThickness}px`;
          p.crossBY.style.height = p.crossBX.style.width = `${crossOuterSize}px`;
          p.crossBY.style.left = p.crossBX.style.top = `${Math.floor(
            crossOuterSize / 2
          ) -
          ...
          p.crossLY.style.background = p.crossLX.style.background =
            THIS.pointerColor;
          p.crossLY.style.height = p.crossLX.style.width = `${crossOuterSize -
            2 * THIS.pointerBorderWidth}px`;
          p.crossLY.style.width = p.crossLX.style.height = `${
            THIS.pointerThickness
          }px`;
          p.crossLY.style.left = p.crossLX.style.top = `${Math.floor(
            crossOuterSize / 2
          ...
          p.sldM.style.top = '0';
          p.sldM.style.width = `${THIS.sliderSize +
            padToSliderPadding / 2 +
            THIS.padding +
            2 * THIS.insetWidth}px`;
          ...
          p.sldPtrIB.style.border = p.sldPtrOB.style.border = `${
            THIS.pointerBorderWidth
          }px solid ${THIS.pointerBorderColor}`;
        ...
        function redrawPad() {
          ...
          switch (jsc.getSliderComponent(THIS)) {
            case 's':
              ...
              var color1 = `rgb(${Math.round(rgb1[0])},${Math.round(
                rgb1[1]
              )},${Math.round(rgb1[2])})`;
              var color2 = `rgb(${Math.round(rgb2[0])},${Math.round(
                rgb2[1]
              )},${Math.round(rgb2[2])})`;
            ...
            case 'v':
              ...
              var color1 = `rgb(${Math.round(rgb[0])},${Math.round(
                rgb[1]
              )},${Math.round(rgb[2])})`;
              var color2 = '#000';
              jsc.picker.sldGrad.draw(
